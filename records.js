...
function updateListenButtonIcons() {
  // Always show the same white speaker icon and gradient background
  const speakerSVG = `
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" style="width: 24px; height: 24px; background: transparent; display: block;">
  ...
  listenButton.innerHTML = speakerSVG;
  listen2Button.innerHTML = speakerSVG;
  listenButton.title = "Listen to example";
  listen2Button.title = "Listen to example";

  // Apply the counter container gradient and circular style
  const gradient = "linear-gradient(135deg, #4b9b94 0%, #2c7873 100%)";
